...
*   **Access Agent Scratchpad:** Review outputs, logs, and generated files from Cura's automations in its dedicated scratchpad ([Agent Scratchpad](/platform/agent-scratchpad)).
*   **Monitor and Manage:** Track agent activity ([Viewing Activity](/platform/activity)), manage usage ([Managing Credits](/platform/credits)), and understand security protocols ([Security & Safety](/platform/security)).
