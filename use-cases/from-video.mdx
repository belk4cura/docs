...
"Automation from Video" allows Cura to learn tasks by watching screen recordings. Provide a video, and Cura analyzes the actions (clicks, typing, navigation) to automatically create a reusable automation, effectively teaching it a new skill visually.
