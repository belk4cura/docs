...
Sometimes you need more than just a quick answer or a single piece of data. "Deep Research" is when you ask Cura to explore a topic in-depth, gather information from various places online, and potentially synthesize or summarize what it finds.

This is significantly different from [Simple Tasks](/use-cases/simple-tasks), where Cura performs a single, focused action like finding one price or logging you in. Deep Research involves Cura acting like a research assistant, navigating through websites, reading content, following relevant links, and pulling together information to answer more complex questions or explore broader subjects.
...
*   **Simple Tasks:** Deep Research answers broader questions, while Simple Tasks fetch specific, known pieces of data.
*   **Complex Data Entry:** Deep Research focuses on *finding and understanding* information, not *entering* it into forms. See [Complex Data Entry](/use-cases/data-entry).
*   **Report Generation:** Deep Research gathers the raw material. [Report Generation](/use-cases/report-generation) focuses on structuring and formatting that material into a final document.
