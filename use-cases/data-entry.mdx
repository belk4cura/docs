...
"Complex Data Entry" involves using Cura for multi-step processes like navigating multi-page forms or transferring data from documents you provide. It goes beyond [Simple Tasks](/use-cases/simple-tasks) by handling longer forms and data transfers, acting like a diligent assistant.
