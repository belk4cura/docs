...
Generating reports often involves gathering information scattered across different websites, dashboards, or documents before compiling it. "Report Generation," in the context of Cura, focuses on automating the **data gathering and consolidation** part of this process.

While Cura itself might not create the final formatted document (like a polished PDF or presentation slides), it acts as an invaluable assistant by collecting all the required data points from various online sources. This saves you the tedious work of manually finding and copying information needed for your reports.
...
*   **Simple Tasks:** Report Generation involves gathering multiple, often related, data points, whereas Simple Tasks usually focus on a single action or piece of data.
*   **Complex Data Entry:** Report Generation is about *extracting* data, while Complex Data Entry is about *inputting* data into forms. See [Complex Data Entry](/use-cases/data-entry).
*   **Deep Research:** While both gather information, Deep Research is often more exploratory and aims to understand a topic broadly, whereas Report Generation focuses on collecting specific, predefined data points needed for a structured report. See [Deep Research](/use-cases/deep-research).
*   **Multi-Site Interactions:** Report Generation frequently *uses* Multi-Site Interactions to gather data from different sources, but its end goal is the collection of data *for reporting purposes*. See [Multi-Site Interactions](/use-cases/multi-site).
