...
# Managing Documents via SDK

This guide explains how to use the Python SDK to upload documents (PDF, Word, images, etc.) associated with specific end-users. Ensure you have followed the [Installation](./tasks.md#installation), [Credentials](./tasks.md#obtaining-credentials), and [Initialization](./tasks.md#initialization) steps first.
