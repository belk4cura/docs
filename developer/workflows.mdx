...
# Managing Workflows via SDK

This guide explains how to use the Python SDK to define, initiate, and monitor multi-step workflows. Ensure you have followed the [Installation](./tasks.md#installation), [Credentials](./tasks.md#obtaining-credentials), and [Initialization](./tasks.md#initialization) steps first.
